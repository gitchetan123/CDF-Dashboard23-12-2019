<%@ Page Title="" Language="C#" MasterPageFile="~/CDFMaster.master" AutoEventWireup="true"
    CodeFile="FellowshipSearch.aspx.cs" Inherits="Search_FellowshipSearch" %>
    ...
    <form id="Form1" class="form-horizontal" role="form" runat="server">
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <div class="panel panel-primary" style="max-width: 700px;">
                    ...
                    <div class="panel-body">
                        <div class="row" style="text-align: center; margin-left: 65px;">
                            <asp:DropDownList ID="ddlFellowship" runat="server" CssClass="form-control" Width="500">
                ...
                <div class="row">
                    <div class="col-md-12 ">
                        <asp:GridView ID="gvFellowship" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="FellowshipName" HeaderText="Fellowship Name" />
                                <asp:BoundField DataField="FellowshipFor" HeaderText="Fellowship For" />
