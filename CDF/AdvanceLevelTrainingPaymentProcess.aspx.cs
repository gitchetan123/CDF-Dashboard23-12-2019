...
{
    public partial class CDF_AdvanceLevelTrainingPaymentProcess : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            productId = Convert.ToInt32(Session["Pid"]);
            ...
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(connectionString))
                {
                    ...
                    if (amount > 0 && paymentId != null)
                    {
                        ...
                        string url = "AdvanceLevelTraining.aspx";
                        Response.Write("<script type='text/javascript'>alert('Payment Successfuly Done.');document.location.href='" + url + "';</script>");
                        //Response.Redirect("AdvanceLevelTraining.aspx", false);
        ...
        public ProductMaster GetProduct(int id)
        {
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(connectionString))
                {
                    ...
                    SqlCommand cmd = new SqlCommand("select * from tblProductMaster where status='ACTIVE' and pId=" + productId, con);
