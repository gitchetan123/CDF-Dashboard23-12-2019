<%@ Page Title="" Language="C#" MasterPageFile="~/CDFMaster.master" AutoEventWireup="true" CodeFile="AdvanceLevelTrainingPayment.aspx.cs" Inherits="CDF_AdvanceLevelTrainingPayment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="x_panel">
        <div class="x_title">
            <h2>Advance Level Training Payment</h2>
        ...
        <div class="x_content">
            ...
            <div class="row rowspace">
                <div class="" id="div_payment" runat="server">
                    <center>
                    <form action="AdvanceLevelTrainingPaymentProcess.aspx" method="post"> 
