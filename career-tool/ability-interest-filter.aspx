<%@ Page Title="" Language="C#" MasterPageFile="~/CDFMaster.master" AutoEventWireup="true"
    CodeFile="ability-interest-filter.aspx.cs" Inherits="AbilityInterestFilter" %>
            ...
            <div class="x_content">
                ...
                <div>
                    <div class="row" style="padding-top: 20px;">
                        ...
                        <div class="col-md-1">
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="drop_ability1"
                                Display="Dynamic" ErrorMessage="Please Select Personality" InitialValue="--Select--">*</asp:RequiredFieldValidator>
                        </div>
                    </div>
                    <div class="row">
                        <label for="name" class="col-md-3 col-md-offset-1 control-label">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-1">
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="drop_ability3"
                                Display="Dynamic" ErrorMessage="Please Select Personality" InitialValue="--Select--">*</asp:RequiredFieldValidator>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="panel panel-primary" id="filter" runat="server">
                        <table class="table text-info">
                            <thead>
                                <tr>
                                    <td width="50%">career filtered as&nbsp; PC- ability and PC - interest &nbsp;=<asp:Label ID="Label1" runat="server" Text="Label"></asp:Label></td>
                                </tr>
                            </thead>
                        </table>
