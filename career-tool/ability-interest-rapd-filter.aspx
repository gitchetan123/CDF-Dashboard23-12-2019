<%@ Page Title="" Language="C#" MasterPageFile="~/CDFMaster.master" AutoEventWireup="true" CodeFile="ability-interest-rapd-filter.aspx.cs" Inherits="career_tool_ability_interest_rapd_filter" %>
                ...
                <div>
                    <div class="row" style="padding-top: 20px;">
                        ...
                        <div class="col-md-5">
                            ...
                            <asp:DropDownList ID="drop_ability1" runat="server" class="form-control" AutoPostBack="true" OnSelectedIndexChanged="drop_ability1_SelectedIndexChanged">
                    ...
                    <div class="row">
                        ...
                        <asp:UpdatePanel ID="UpdatePanel17" runat="server" UpdateMode="Conditional">
                            <Triggers>
                                <asp:AsyncPostBackTrigger ControlID="drop_ability1" EventName="SelectedIndexChanged" />
                            </Triggers>
                            <ContentTemplate>
                                <label for="name" class="col-md-3 col-md-offset-1 control-label">
                                    Ability 2</label>
                                <div class="col-md-5">
                                    <asp:DropDownList ID="drop_ability2" runat="server" class="form-control" AutoPostBack="true" OnSelectedIndexChanged="drop_ability2_SelectedIndexChanged">
                                        <asp:ListItem>--Select--</asp:ListItem>
                                        <%--<asp:ListItem Value="Observation and Concept Formation">Observation and Concept Formation</asp:ListItem>
                                <asp:ListItem Value="Spatial Awareness">Spatial Awareness</asp:ListItem>
                                <asp:ListItem Value="Observation and Spatial Transformation">Observation and Spatial Transformation</asp:ListItem>
                    ...
                    <div class="row">
                        <asp:UpdatePanel ID="UpdatePanel18" runat="server" UpdateMode="Conditional">
                            <Triggers>
                                <asp:AsyncPostBackTrigger ControlID="drop_ability2" EventName="SelectedIndexChanged" />
                            </Triggers>
                            <ContentTemplate>
                                <label for="name" class="col-md-3 col-md-offset-1 control-label">
                                    Ability 3</label>
                    ...
                    <div class="row">
                        <label for="name" class="col-md-3 col-md-offset-1 control-label">
                            Interest 1</label>
                        <div class="col-md-5">
                            <asp:DropDownList ID="drop_interest1" runat="server" class="form-control" AutoPostBack="true" OnSelectedIndexChanged="drop_interest1_SelectedIndexChanged">
                                <asp:ListItem>--Select--</asp:ListItem>
                    ...
                    <div class="row">
                        <asp:UpdatePanel ID="UpdatePanel19" runat="server" UpdateMode="Conditional">
                            <Triggers>
                                <asp:AsyncPostBackTrigger ControlID="drop_interest1" EventName="SelectedIndexChanged" />
                            </Triggers>
                            <ContentTemplate>
                                <label for="name" class="col-md-3 col-md-offset-1 control-label">
                                    Interest 2</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-1">
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="drop_rScore"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-1">
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="drop_aScore"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-1">
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="drop_pScore"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-1">
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ControlToValidate="drop_dScore"
