...
public partial class pre_custom_payment : System.Web.UI.Page
{
    ...
    public void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Session["uid"] != null)
            {
                ...
                {
                    if (Session["CustomPaymentAmount"].ToString() == "33500" || Session["CustomPaymentAmount"].ToString() == "15000" || Session["CustomPaymentAmount"].ToString() == "20000")
                    {
                    ...
                    else
                    {
                        ...
                        query = "Select A.id,A.status,A.amount, B.contactNo from tblCustomPayment as A Inner Join tblUserMaster as B on A.uId = B.uId where A.uId = '" + Session["uid"].ToString() + "' and A.status = 'ACTIVE'";
                    }
