...
public class db_context
{
    ...
    public db_context()
    {
        strcon = ConfigurationManager.ConnectionStrings["DBConnection"].ConnectionString.ToString();
    ...
    public SqlDataReader ExecDataReader1(string s_query, int id)
    {
        using (SqlConnection con = new SqlConnection(strcon))
        {
            // Call function  ConOpen for Open the Database Connection
    ...
    // c_id, agreed_amount, createdBy, txt_comment.Text
    public int ExecNonQuery(string s_query, int c_id, int agreed_amount, int createdBy, int updatedBy, string comment)
    {
        try
        {
            using (SqlConnection con = new SqlConnection(strcon))
            {
                ...
                cmd.Parameters.AddWithValue("@agreedAmount", agreed_amount);
    ...
    public int ExecNonQuery(string s_query, int c_id, string Status, DateTime updatedDate, int updatedBy)
    {
        try
        {
            using (SqlConnection con = new SqlConnection(strcon))
            {
                ...
                cmd.Parameters.AddWithValue("@dateModified", updatedDate);
    ...
    public int ExecNonQuery(string queryUpdate, int c_id, bool GBL, string GBLStatus, string StoreCode, string comment, int createdBy, int updatedBy)
    {
        try
        {
            using (SqlConnection con = new SqlConnection(strcon))
            {
                ...
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@uId", c_id);
                cmd.Parameters.AddWithValue("@GBL", GBL);
                cmd.Parameters.AddWithValue("@status", GBLStatus);
    ...
    // c_id, agreed_amount, createdBy, txt_comment.Text , Locked AMOUNT
    public int ExecNonQuery(string s_query, int c_id, int agreed_amount, int locked, int createdBy, int updatedBy, string comment)
    {
        try
        {
            using (SqlConnection con = new SqlConnection(strcon))
    ...
    public SqlDataReader ExecDataReader(string s_query, int id)
    {
        using (SqlConnection con = new SqlConnection(strcon))
        {
            // Call function  ConOpen for Open the Database Connection
    ...
    public int ExecNonQuery(string s_query, string file_name, int row_count, int createdBy)
    {
        try
        {
            using (SqlConnection con = new SqlConnection(strcon))
            {
                ...
                SqlCommand cmd = new SqlCommand(s_query, con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@data_file_name", file_name);
                cmd.Parameters.AddWithValue("@data_count", row_count);
                cmd.Parameters.AddWithValue("@export_by", createdBy);
                int intEffectedRows = cmd.ExecuteNonQuery();
                return intEffectedRows;
            }
        }
    ...
    #region filter data
    public DataSet ExecDataSet_byLevel(string s_query, int status, string level)
    {
        try
        {
            using (SqlConnection con = new SqlConnection(strcon))
            {
                ...
                cmd.Parameters.AddWithValue("@cdfLevel", level);
    ...
    public DataSet ExecDataSet_byCity(string s_query, int status, string cityId)
    {
        try
        {
            using (SqlConnection con = new SqlConnection(strcon))
    ...
    public DataSet ExecDataSet_byLevelAndCity(string s_query, int status, string level, string cityId)
    {
        try
        {
            using (SqlConnection con = new SqlConnection(strcon))
    ...
    public DataSet ExecDataSet_byTestStatusAndCity(string s_query, int status, string testStatus, string cityId)
    {
        try
        {
            using (SqlConnection con = new SqlConnection(strcon))
            {
                ...
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@status", status);
                cmd.Parameters.AddWithValue("@cdfLevel", testStatus);
                cmd.Parameters.AddWithValue("@cityid", cityId);
                //cmd.Parameters.AddWithValue("@fromDate", fromDate);
                //cmd.Parameters.AddWithValue("@toDate", toDate);
                //cmd.Parameters.AddWithValue("@dob", dob);
    ...
    public DataSet ExecDataSet_byRegDate(string query, int status, string fromDate, string toDate)
    {
        try
        {
            using (SqlConnection con = new SqlConnection(strcon))
    ...
    public DataSet ExecDataSet_All(string query, int status)
    {
        try
        {
            using (SqlConnection con = new SqlConnection(strcon))
    ...
    public SqlDataReader ExecDataReader12(string s_query, int id)
    {
        // Call function  ConOpen for Open the Database Connection
        ConOpen();
    ...
    public DataTable FillGrid(string SP_Name, string SP_Type)
    {
        try
        {
            using (SqlConnection con = new SqlConnection(strcon))
            {
                ...
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@SP_Type", SP_Type);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
