<%@ Page Title="" Language="C#" MasterPageFile="~/CDFMaster.master" AutoEventWireup="true" CodeFile="sell-form.aspx.cs" Inherits="Sale_sell_form" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        function openModal_lead() {
            $('#myModalPopup_lead').modal('show');
            $('#myModalPopup_case').modal('hide');
            $('#myModalPopup_contact').modal('hide');
        }
        function openModal_contact() {
            $('#myModalPopup_contact').modal('show');
            $('#myModalPopup_lead').modal('hide');
            $('#myModalPopup_case').modal('hide');
        }
        function openModal_case() {
            $('#myModalPopup_case').modal('show');
            $('#myModalPopup_lead').modal('hide');
            $('#myModalPopup_contact').modal('hide');
        }
    </script>
                    ...
                    <div class="container" align="center">
                        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <%--<div class="col-md-5 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                         <span class="leftalign">Select Referral Type:* </span>
                                            <asp:RadioButton ID="rblCase" runat="server" Text="  Case" GroupName="userType" OnCheckedChanged="rblCase_CheckedChanged" AutoPostBack="true"/>  &nbsp; &nbsp; &nbsp;
                                            <asp:RadioButton ID="rblLead" runat="server" Text="  Lead" GroupName="userType" OnCheckedChanged="rblLead_CheckedChanged" AutoPostBack="true"/> &nbsp; &nbsp; &nbsp;
                                            <asp:RadioButton ID="rblContact" runat="server" Text="  Contact" GroupName="userType" OnCheckedChanged="rblContact_CheckedChanged" AutoPostBack="true"/>
                                        </div>
                                 </div>--%>
                            </div>
