<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/admin-master.master" AutoEventWireup="true" CodeFile="training-batches.aspx.cs" Inherits="Admin_ExportData_training_batches" %>
            ...
            <div class="x_content">
                ...
                <div>
                    <div class="row form-group " style="padding-top: 20px;">
                        <label style="text-align: right;" class="col-sm-3 col-sm-offset-1  control-label">
                            Search By :</label>
                        <div class="col-sm-6">
                            <asp:TextBox ID="txt_name" placeholder="Batch Name or Trainer Name or Location or City" class="form-control"
                    ...
                    <div class="row form-group ">
                        <label style="text-align: right;" class="col-sm-3 col-sm-offset-1  control-label">
                            Search By Count :</label>
                        <div class="col-sm-6">
                            <asp:TextBox ID="txt_count" placeholder="Total CDF Count" class="form-control"
                                runat="server"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <div class="row form-group ">
                        ...
                        <div class=" col-sm-2">
                            <asp:Button ID="btnExport" runat="server" CssClass="btn btn-primary btn-block btn1"
                ...
                <div>
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                        ...
                        Width="100%" OnPageIndexChanging="GridView1_PageIndexChanging" PageSize="15"
                        AllowSorting="True">

                        <%--OnDataBound="GridView1_DataBound"  OnRowDataBound="GridView1_RowDataBound"  OnRowCommand="GridView1_RowCommand"DataKeyNames="id"OnSorting="GridView1_Sorting" --%>
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="BatchName" HeaderText="Batch Name" SortExpression="BName">
                                <HeaderStyle Wrap="False" />
                            </asp:BoundField>
                            <asp:BoundField DataField="Trainer_Name" HeaderText="Trainer Name" SortExpression="TName" />
                            <asp:BoundField DataField="Date_Conducted" HeaderText="Date Conducted" SortExpression="regDateTime"
                                DataFormatString="{0:dd/MM/yyyy}">
                                <HeaderStyle Wrap="False" />
                            </asp:BoundField>
                            <asp:BoundField DataField="TotalNumberOfPeopleInBatch" HeaderText="Count" SortExpression="totCDF">
                                <HeaderStyle Wrap="False" />
                            </asp:BoundField>
                            <asp:BoundField DataField="Location" HeaderText="Location" SortExpression="Location" />
                            <asp:BoundField DataField="CityName" HeaderText="City" SortExpression="CtyName" />
                            <asp:BoundField DataField="cdfLevel" HeaderText="Level" SortExpression="cdfLevel" />
